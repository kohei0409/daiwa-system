...
@section('content')
    <div class="row">
        <div class="col-8 offset-2 mb-5">
            <h2>業者更新</h2>
            <form method="POST" action="{{ route('manufacturers_update') }}" onSubmit="return checkSubmit()">
                @csrf
                ...
                <input
                    ...
                    class="form-control"
                    value="{{ $manufacturer->manufacturers_id }}"
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        class="form-control"
                        value="{{ $manufacturer->manufacturers_name }}"
                        type="text"
                    >
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        class="form-control"
                        value="{{ $manufacturer->manufacturers_post }}"
                        type="text"
                    >
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        class="form-control"
                        value="{{ $manufacturer->manufacturers_address }}"
                        type="text"
                    >
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        class="form-control"
                        value="{{ $manufacturer->manufacturers_tel }}"
                        type="text"
                    >
